...
**Front of card:** Kanji (or Hiragana if no Kanji exists for that word) + reading
...
run this locally with Python 3:
...
```
index.html   markup
style.css    design system (Japanese stationery / genkō-yōshi inspired)
